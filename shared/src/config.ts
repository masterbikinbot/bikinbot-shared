...
export const PLAN_TIERS: Record<string, PlanTier> = {
  ...
  pro: {
    ...
    monthlyFeatures: [
      'Semua fitur Basic +',
      '4GB RAM (upgrade dari 2GB)',
      '10GB Storage (upgrade dari 5GB)',
      'Rp 200.000 Credit AI/bulan',
      'Priority Support',
    ],
    annualFeatures: [
      'Semua fitur Basic +',
  ...
  ultra: {
    ...
    monthlyFeatures: [
      'Semua fitur Pro +',
      '8GB RAM (upgrade dari 4GB)',
      '25GB Storage (upgrade dari 10GB)',
